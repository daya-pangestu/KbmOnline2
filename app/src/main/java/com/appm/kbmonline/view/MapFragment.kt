...
class MapFragment : Fragment(), OnMapReadyCallback {
    ...
    private fun moveCameraToOrigin(origin : LatLng, titile : String = "bandung", snippet : String = "bandung"){
    ...
    private fun moveCameraToDestination(destination : LatLng, titile  : String= "jakarta", snippet : String = "jakarta"){
        mMapboxMap.animateCamera(CameraUpdateFactory.newCameraPosition(
            CameraPosition.Builder()
                .target(destination)
                .zoom(6.0)
